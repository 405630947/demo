...
public class MyAdapter<T> extends BaseAdapter implements Filterable {
    /**
     * Contains the list of objects that represent the data of this MyAdapter.
    ...
    private View createViewFromResource(int position, View convertView, ViewGroup parent,
        ...
        try {
            ...
            Log.e("MyAdapter", "You must supply a resource ID for a TextView");
            throw new IllegalStateException(
                    "MyAdapter requires the resource ID to be a TextView", e);
        }
    ...
    /**
     * Creates a new MyAdapter from external resources. The content of the array is
     ...
     *
     * @return An MyAdapter<CharSequence>.
     */
    public static MyAdapter<CharSequence> createFromResource(Context context,
                                                                int textArrayResId, int textViewResId) {
        CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new MyAdapter<CharSequence>(context, textViewResId, strings);
    }
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    if (valueText.startsWith(prefixString)) {
                        ...
                        for (int k = 0; k < wordCount; k++) {
                            if (words[k].indexOf(prefixString)!=-1) {//源碼 ,匹配開頭
                                newValues.add(value);
                                break;
                            }
                        }
